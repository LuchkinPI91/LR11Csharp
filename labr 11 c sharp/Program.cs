...
namespace labr11_c_sharp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Введите 2 студентов:");// массив объектов
            for (int i = 0; i < 2; i++)
            {
            ...
            for (int i = 0; i < n; i++) {
                ...
                q = Console.ReadLine();
                ob[i, 0].set_last_name(q, i);
               
                Console.WriteLine("Введите оценку за 1 экзамен:");
                double x = Convert.ToDouble(Console.ReadLine());
                ob[i, 1].set_avg_balls1(x,i);
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                Console.WriteLine($"Имя:{ob[i, 0].getName(i)} Оценка за 1 экзамен:{ob[i, 1].get_avg_balls1(i)}");
    ...
    class Students
    {
        ...
        public void set_avg_balls1(double avg_balls1, int i) {

            avg_ball1[i] = avg_balls1;
        
        }

        public double get_avg_balls1(int i) {

            return avg_ball1[i];

        }

        public void set_last_name(String last_name, int i)
        {
